...
export class Util {
    ...
    */
     ...
     * @param {*} list 
     */
    query_array_to_string = (list: []): string => {
        return "'" + list.join("','") + "'";
    }
     ...
     * @param {*} list 
     */
    query_array_to_integer = (list: []): string => {
        return list.join(",");
    }
     ...
     * @returns 
     */
    checkBirth = (birth: string): boolean => {
     ...
     * @returns 
     */
    changeBcrypt = async (str: string): Promise<string> => {
     ...
     * @param {*} strB 
     */
    matchBcrypt = async (strA: string, strB: string): Promise<boolean> => {
